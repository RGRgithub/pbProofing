...
{
  player.once(() => {
const target = object('62JjKRKOSLT');
const duration = 1500;
...
{
  player.once(() => {
const target = object('5hsw4tNMWQD');
const duration = 1500;
const easing = 'ease-out';
...
{
  player.once(() => {
const target = object('6EZLiN2RpCd');
const duration = 750;
const easing = 'ease-out';
const id = '5z9UfTrdM1y';
...
{
  player.once(() => {
const target = object('5xolQsvEyQI');
const duration = 750;
const easing = 'ease-out';
const id = '6SGnCyIqCQ3';
const pulseAmount = 0.07;
const delay = 11000;
addToTimeline(
target.animate(
...
{
  player.once(() => {
const target = object('6aZpEBfclx8');
const duration = 1250;
const easing = 'ease-out';
const id = '6FhjJlQyfUc';
const pulseAmount = 0.1;
...
{
  player.once(() => {
const target = object('5iQZbWtcGvv');
const duration = 1500;
const easing = 'ease-out';
const id = '6JZNKXpGwsu';
const pulseAmount = 0.07;
...
{
  player.once(() => {
const target = object('5bvNJ8s1uWr');
const duration = 750;
const easing = 'ease-out';
const id = '6Tv3qMU47nQ';
const pulseAmount = 0.07;
